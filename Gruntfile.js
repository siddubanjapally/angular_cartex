  ...
  module.exports = function(grunt) {
    ...
    return grunt.initConfig({
      ...
      coffee: {
        ...
        combined: {
          files: {
            'build/js/<%= pkg.name %>.js': ['src/coffee/app.coffee', 'src/coffee/**/!(app).coffee', 'src/coffee/**/!(.#*)']
          }
        }
      },
      jade: {
      ...
      uglify: {
        ...
        libs: {
          files: {
            'build/js/lib.min.js': ['build/lib/jquery/jquery.js', 'build/lib/angular/angular.js', 'build/lib/angular-route/angular-route.js', 'build/lib/bootstrap/bootstrap.js', 'build/lib/Faker/Faker.js', 'build/lib/lodash/lodash.compat.js', 'src/lib/*.js']
          }
        }
      },
      connect: {
